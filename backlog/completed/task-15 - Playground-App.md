...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 UI to select provider, connect, and perform CRUD
- [x] #2 Displays connection status, profile info, and document list
- [x] #3 Works with local provider out of the box
- [x] #4 Runs via turbo dev --filter=playground
<!-- AC:END -->
